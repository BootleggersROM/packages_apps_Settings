...
public class SystemUpdatePreferenceController extends BasePreferenceController {
    ...
    private static final String OTA_BUILD_TYPE_PROP = "ro.bootleggers.releasetype";
    private static final String DEVICE_NAME = "ro.bootleggers.device";
    private static final String OTA_APP_PACKAGE = "com.bootleggers.shishuota";
    ...
    public int getAvailabilityStatus() {
        String buildtype = SystemProperties.get(OTA_BUILD_TYPE_PROP,"Aidonnou");
        String deviceName = SystemProperties.get(DEVICE_NAME,"");
        if (!mUm.isAdminUser() || !buildtype.equalsIgnoreCase("Shishufied")){
